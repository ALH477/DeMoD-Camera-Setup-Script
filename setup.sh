...
echo "Setup complete. MediaMTX is ready in the current directory. Run start.sh for CLI or python3 config.py for web configuration. For large-scale, use config.jsonc."
